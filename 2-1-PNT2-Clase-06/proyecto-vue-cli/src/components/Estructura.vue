  ...
  <section class="src-components-estructura">
    <div class="jumbotron">
      ...
      <p v-if="mostrar" class="alert alert-warning">
        ...
        tenetur doloribus, soluta voluptatum ex, corrupti culpa perspiciatis at
        neque minus nisi recusandae hic voluptatibus dolor fuga, est nobis
        vitae.
      </p>
        ...
        <div class="table-responsive">
          ...
          <div class="alert alert-info">
            ...
            <div v-else>
              ...
              el curso, en un total de {{ alumnosConCurso.total }} alumnos
            </div>
          </div>
        </div>
